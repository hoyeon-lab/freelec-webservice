...
nohup java \
    -Dspring.config.location=classpath:/application.properties,classpath:/application-${IDLE_PROFILE}.properties,/home/ec2-user/app/application-oauth2.properties,/home/ec2-user/app/application-real-db.properties \
